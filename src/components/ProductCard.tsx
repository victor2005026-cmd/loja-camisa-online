  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-xl border border-line bg-surface transition-all duration-200 hover:-translate-y-1 hover:border-ouro hover:shadow-[0_12px_32px_-12px_rgba(201,162,74,0.35)]">
      <div className="relative aspect-square w-full overflow-hidden">
        ...
        <div className="pointer-events-none absolute inset-0 z-10 flex flex-col items-center justify-center gap-2 bg-ink/70 opacity-0 backdrop-blur-sm transition-opacity duration-200 group-hover:opacity-100">
          <Link
            href={`/produto/${camisa.id}#comprar`}
            className="pointer-events-auto w-32 rounded-full bg-flare px-4 py-1.5 text-center text-xs font-semibold text-ink transition hover:brightness-110"
          >
            Comprar
          </Link>
          <Link
            href={`/produto/${camisa.id}`}
            className="pointer-events-auto w-32 rounded-full border border-paper/60 px-4 py-1.5 text-center text-xs font-semibold text-paper transition hover:border-paper"
          >
            Saiba mais
          </Link>
          <a
            ...
            className="pointer-events-auto mt-1 flex h-8 w-8 items-center justify-center rounded-full bg-[#25D366] text-white transition hover:brightness-110"
          >
