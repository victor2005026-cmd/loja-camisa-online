...
export function WhatsAppButton() {
  ...
  return (
    <a
      ...
      className={`fixed right-5 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition hover:brightness-110 ${
        cartBarVisivel ? "bottom-20" : "bottom-5"
      }`}
    >
